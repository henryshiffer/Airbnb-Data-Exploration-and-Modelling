...
![](Initial-Data-Exploration-Week-2---3_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
```
    ...
    ## # A tibble: 2 x 7
    ##   neighbourhood name  property_type room_type host_id minimum_nights
    ##   <chr>         <chr> <chr>         <chr>       <dbl>          <dbl>
    ## 1 <NA>          Resi… Room in hotel Hotel ro…  3.32e8             28
    ## 2 <NA>          Resi… Room in apar… Hotel ro…  3.17e8             28
